...
# the code here transforms a vector into a tibble,
enframe(nhanes_descr) %>% 
  # this code is relevant for exercise 4. Please use it as a template.
...
#
# nhanes_sample %>%       [I start with the solution from problem 2]
#   select() %>%          [I remove one column]
#   kable() %>%           [I supply column labels]
#   kable_styling() %>%   [I style]
#   footnote()            [I add a general footnote]
